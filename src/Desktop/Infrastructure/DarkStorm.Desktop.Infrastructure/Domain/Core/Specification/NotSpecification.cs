namespace DarkStorm.Desktop.Infrastructure.Domain.Core.Specification
{
    using System;
    using System.Linq;
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="DarkStorm.Domain.Core.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="DarkStorm.Domain.Core.Specification.ISpecification{TEntity}"/></returns>
